...
var author$project$Loan$Model = F3(
...
var author$project$Main$Model = function (f_hv) {
	return function (c_hv) {
		return function (f_hr) {
			return function (c_hr) {
				return function (f_he) {
					return function (c_he) {
						return function (f_lt) {
							return function (f_lr) {
								return function (loan) {
									return function (f_pay) {
...
var author$project$Loan$wInY = 52;
var elm$core$Basics$fdiv = _Basics_fdiv;
var author$project$Loan$w_interest_rate = function (loan) {
	return loan.interest_rate / author$project$Loan$wInY;
};
...
var author$project$Loan$payment = function (loan) {
	...
	var n = author$project$Loan$paymentsNumber(loan);
	var d = r / (1 - A2(elm$core$Basics$pow, 1 + r, -n));
...
var author$project$Main$updateCalculations = function (m) {
	...
	var old_loan = m.loan;
	var new_loan = _Utils_update(
		old_loan,
		{amount: up_la});
	var wpay = author$project$Main$weeklyPayment(
		_Utils_update(
			m,
			{loan: new_loan}));
	return _Utils_update(
		m,
		{c_pay: wpay, loan: new_loan});
};
...
var author$project$Main$resetError = function (f) {
	return _Utils_update(
		f,
...
var author$project$Main$updateField = F6(
	function (m, s, o_f, v, up_f, up_c) {
		var n_f = A2(author$project$Main$setValue, s, o_f);
		var _n0 = v(
			{value: s});
		if (_n0.$ === 'Err') {
			var e = _n0.a;
			return A2(
				up_f,
				m,
				A2(author$project$Main$setError, e, n_f));
		} else {
			var f = _n0.a;
			return author$project$Main$updateCalculations(
				A2(
					up_f,
					A2(up_c, m, f.value),
...
var author$project$Validators$isFloat = function (error) {
	return A2(
		elm$core$Basics$composeR,
		elm$core$String$toFloat,
		elm$core$Result$fromMaybe(
			_Utils_Tuple2(error, _List_Nil)));
};
var stoeffel$elm_verify$Verify$ok = F2(
	function (f, _n0) {
		return elm$core$Result$Ok(f);
	});
var stoeffel$elm_verify$Verify$validate = stoeffel$elm_verify$Verify$ok;
var stoeffel$elm_verify$Verify$custom = F3(
	function (v2, v1, input) {
			...
			if (_n0.b.$ === 'Err') {
				...
				return elm$core$Result$Err(
					_Utils_Tuple2(
						...
						_Utils_ap(
							rest1,
							A2(elm$core$List$cons, e2, rest2))));
			} else {
				var e1 = _n0.a.a;
...
var stoeffel$elm_verify$Verify$verify = F3(
	function (f, v1, v2) {
		return A2(
			stoeffel$elm_verify$Verify$custom,
			A2(elm$core$Basics$composeR, f, v1),
			v2);
	});
var author$project$Main$validateFloatField = A3(
	stoeffel$elm_verify$Verify$verify,
	function ($) {
		return $.value;
	},
	author$project$Validators$isFloat('Value must be a float'),
	stoeffel$elm_verify$Verify$validate(author$project$Main$FField));
var author$project$Main$IField = function (value) {
	return {value: value};
};
var elm$core$String$toInt = _String_toInt;
var stoeffel$elm_verify$String$Verify$isInt = function (error) {
	return A2(
		elm$core$Basics$composeR,
...
var author$project$Main$validateIntField = A3(
	stoeffel$elm_verify$Verify$verify,
	function ($) {
		return $.value;
	},
	stoeffel$elm_verify$String$Verify$isInt('Value must be an integer'),
	stoeffel$elm_verify$Verify$validate(author$project$Main$IField));
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'None':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'ChangeHouseValue':
				var s = msg.a;
				return _Utils_Tuple2(
					A6(
			...
			case 'ChangeLoanTerm':
				...
				return _Utils_Tuple2(
					A6(
						...
						s,
						model.f_lt,
						author$project$Main$validateIntField,
						F2(
							function (m, f) {
								return _Utils_update(
									m,
							...
							return rundis$elm_bootstrap$Bootstrap$Form$Input$text(
								_List_fromArray(
									[
										...
										rundis$elm_bootstrap$Bootstrap$Form$Input$value(f.value),
...
var author$project$Main$ChangeHouseExtras = function (a) {
	return {$: 'ChangeHouseExtras', a: a};
};
var author$project$Main$ChangeHouseRate = function (a) {
	return {$: 'ChangeHouseRate', a: a};
};
var author$project$Main$ChangeHouseValue = function (a) {
	return {$: 'ChangeHouseValue', a: a};
};
var author$project$Main$viewHouseForm = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Form$row,
		_List_Nil,
		elm$core$List$concat(
			_List_fromArray(
				[
					A2(author$project$Main$viewField, model.f_hv, author$project$Main$ChangeHouseValue),
					A2(author$project$Main$viewField, model.f_hr, author$project$Main$ChangeHouseRate),
					A2(author$project$Main$viewField, model.f_he, author$project$Main$ChangeHouseExtras)
				])));
};
var author$project$Main$ChangeLoanRate = function (a) {
	return {$: 'ChangeLoanRate', a: a};
};
var author$project$Main$ChangeLoanTerm = function (a) {
	return {$: 'ChangeLoanTerm', a: a};
};
var author$project$Main$viewLoanForm = function (model) {
	return A2(
		rundis$elm_bootstrap$Bootstrap$Form$row,
		_List_Nil,
		elm$core$List$concat(
			_List_fromArray(
				[
					A2(author$project$Main$viewField, model.f_lt, author$project$Main$ChangeLoanTerm),
					A2(author$project$Main$viewField, model.f_lr, author$project$Main$ChangeLoanRate),
					_List_fromArray(
					[
						A2(rundis$elm_bootstrap$Bootstrap$Form$col, _List_Nil, _List_Nil),
						A2(rundis$elm_bootstrap$Bootstrap$Form$col, _List_Nil, _List_Nil)
...
var author$project$Main$viewForm = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				author$project$Main$viewHouseForm(model),
...
var author$project$Loan$w_principal = F2(
	function (loan, pay) {
...
var author$project$Loan$interest_ = F2(
	function (loan, pay) {
		...
		var wi = author$project$Loan$w_interest(loan);
		var new_loan = _Utils_update(
			loan,
			{amount: loan.amount - wp, term: loan.term - 1});
		return (!loan.term) ? 0 : (wi + A2(author$project$Loan$interest_, new_loan, pay));
	});
var author$project$Loan$interest = function (loan) {
	return A2(
		author$project$Loan$interest_,
		loan,
		author$project$Loan$payment(loan));
};
var author$project$Loan$cost = function (loan) {
	return author$project$Loan$interest(loan) + loan.amount;
};
var elm$html$Html$dd = _VirtualDom_node('dd');
var elm$html$Html$dt = _VirtualDom_node('dt');
var author$project$Main$viewCalculusField = F2(
	function (tt, vt) {
		return _List_fromArray(
			[
				A2(
...
var author$project$Main$viewLoanCalculus = function (model) {
	return A2(
			...
			[
				...
				elm$core$List$concat(
					_List_fromArray(
						[
							A2(
							author$project$Main$viewCalculusField,
							'Amount',
							author$project$Main$viewAsDollar(model.loan.amount)),
							A2(
							author$project$Main$viewCalculusField,
							'Term',
							A3(author$project$Main$pluralize, 'year', 'years', (model.loan.term / 52) | 0)),
							A2(
							author$project$Main$viewCalculusField,
							'Interest',
							author$project$Main$viewAsDollar(
								author$project$Loan$interest(model.loan))),
							A2(
							author$project$Main$viewCalculusField,
							'Cost',
							author$project$Main$viewAsDollar(
								author$project$Loan$cost(model.loan))),
							A2(
							author$project$Main$viewCalculusField,
							'Weekly payment ',
							author$project$Main$viewAsDollar(
								author$project$Loan$payment(model.loan)))
						])))
			]));
};
...
var author$project$Main$view = function (model) {
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text('Rent-to-buy scheme')
						])),
	...
	return {body: body, title: 'Rent to buy'};
};
